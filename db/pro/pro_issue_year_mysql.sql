...
DROP TABLE IF EXISTS pro_issue_year;
...
(
	id bigint(64) NOT NULL AUTO_INCREMENT COMMENT 'id',
	pro_audience_ratings_id bigint(64) NOT NULL COMMENT '收视率主信息',
	pro_audience_target_id bigint(64) COMMENT '收视目标',
	bro_date int COMMENT '播出日期',
	bro_time_start varchar(64) COMMENT '开始时间',
	bro_time_end varchar(64) COMMENT '结束时间',
